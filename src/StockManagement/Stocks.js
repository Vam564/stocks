                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body mb-1">
                                                    ...
                                                    <div class="text-center mt-2">
                                                        <button class="btn btn-info" style={{ borderRadius: '30px' }} onClick={() => goToPositionsBuy(currentIndex)}  data-dismiss="modal" >Done <i class="fas fa-sign-in ml-1"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                            {/* <!--/.Content--> */}
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body mb-1">
                                                    ...
                                                    <div class="md-form form-sm">
                                                        ...
                                                        <input type="number" id="price" value={currentStock.price}  class="form-control"onChange={handleInput} />
                                                    ...
                                                    <div class="text-center mt-2">
                                                        <button class="btn btn-danger" style={{ borderRadius: '30px' }} onClick={() => goToPositionsSell(currentIndex)}  data-dismiss="modal" >Done <i class="fas fa-sign-in ml-1"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                            {/* <!--/.Content--> */}
